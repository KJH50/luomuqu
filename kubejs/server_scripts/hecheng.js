    ...
    event.shaped('celestial_artifacts:catastrophe_scroll',[
        ...
        ['iceandfire:dragonbone','iceandfire:dragonbone','iceandfire:dragonbone'],
            ...
            event.shaped('minecraft:slime_ball',[
                ['minecraft:snowball','minecraft:green_dye']
            ])

            event.shaped('alexsmobs:spawn_egg_comb_jelly',[
                ['iceandfire:pixie_dust','irons_spellbooks:legendary_ink']
            ])

            event.shaped('celestial_artifacts:chaotic_etching',[
                ['minecraft:netherite_ingot','minecraft:tnt','minecraft:netherite_ingot'],
                ['minecraft:tnt','celestial_core:fire_essence','minecraft:tnt'],
                ['minecraft:netherite_ingot','minecraft:tnt','minecraft:netherite_ingot']
            ])

            event.shaped('touhou_little_maid_spell:hairpin',[
                ['minecraft:golden_apple','celestial_core:sakura_steel','celestial_core:sakura_steel'],
                ['celestial_core:sakura_steel','goety:ectoplasm','celestial_core:sakura_steel'],
                ['celestial_core:sakura_steel','celestial_core:sakura_steel','minecraft:totem_of_undying']
            ])
